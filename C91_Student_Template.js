...
function my_keydown(e)
{
	...
	console.log(keyPressed);
		...
		{
			cosole.log("car1");
			document.getElementById('game status').innerHTML = "¡Gana el auto 1!";
		}
		if(car2_x > 700)
		{
			cosole.log("car2");
			document.getElementById('game status').innerHTML = "¡Gana el auto 2!";
		}
}
...
function car1_up()
{
	...
	{
		car1_y = car1_y - 10;
		console.log("Cuando se presione la flecha de arriba, x = " + car1_x + " | y =" + car1_y)
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_down()
{
	...
	{
		car1_y = car1_y + 10;
		console.log("Cuando se presione la flecha de abajo, x = " + car1_x + " | y =" + car1_y)
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
